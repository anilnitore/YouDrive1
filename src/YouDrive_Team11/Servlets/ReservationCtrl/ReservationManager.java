...
public class ReservationManager extends HttpServlet {
				...
				if(customer!=null){
					...
					if(req.getParameter("placeReservation")!=null){
						try{
							...
							System.out.println("Could not place reservation"+e.getClass()+e.getMessage());
					...
					if(req.getParameter("placeReservationFinal")!=null){
						...
						try{
							...
							//Forward to Reservation History page
							dispatcher=ctx.getRequestDispatcher("/history.jsp");
							System.out.print("Running1");
							dispatcher.forward(req, res);
							System.out.print("Running2");
	...
	public Date returnEndDate(String mm, String dd, String yyyy, int time, boolean hours) throws ParseException{
		if(hours){
			...
			java.util.Date utilDate=new SimpleDateFormat("MM/dd/yyyy").parse(mm+"/"+dd+"/"+yyyy);
			java.sql.Date date=new java.sql.Date(utilDate.getTime());
			System.out.print("Running3"+date);
			//Get the start date in hours
			System.out.print("Running4"+utilDate);
//			int h=date.getHours();
//			System.out.print("Running5");
//			//Add the hours to the start date
//			int newh=h+time;
//			System.out.print("Running6");
//			date.setHours(newh);
//			System.out.print("Running7");
			return date;
		}
		else{
			...
			java.util.Date utilDate=new SimpleDateFormat("MM/dd/yyyy").parse(mm+"/"+dd+"/"+yyyy);
			System.out.print("Running8");
			java.sql.Date date=new java.sql.Date(utilDate.getTime());
			System.out.print("Running9");
//			//Get the start date in hours
//			int d=date.getDay();
//			System.out.print("Running10");
//			//Add the hours to the start date
//			int newd=d+time;
//			System.out.print("Running11");
//			date.setDate(newd);
			return date;
		}
	}
